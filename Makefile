PROJECT_NAME     := ble_app_hts_ds1820_pca10040_s132
...
$(OUTPUT_DIRECTORY)/nrf52832_xxaa.out: \
  LINKER_SCRIPT  := ble_app_hts_ds1820_gcc_nrf52.ld
...
INC_FOLDERS += \
  $(PROJ_DIR)/config/ble_app_hts_pca10040_s132 \
  $(PROJ_DIR)/config \
...
CFLAGS +=  -Wall -O3 -g3 #-Werror TODO: Turn this on before production
