...
#define NRF_LOG_MODULE_NAME "THERMOMETER"
#include "nrf_log.h"
...
#define DEVICE_NAME                     "WBBB_Thermometer"                                /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME               "Webrewthebestbeer1"                       /**< Manufacturer. Will be passed to Device Information Service. */
#define MODEL_NUM                       "1"                            /**< Model number. Will be passed to Device Information Service. */
